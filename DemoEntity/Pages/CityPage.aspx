...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="dnnFormItem" style="text-align: center">
        <a id="btnRouView" href="#" class="cms-button cms-button-small">Đổi</a>
        <input type="text" class="clearable" id="txtRoute" placeholder="<Nhập điểm xuất phát hoặc Click trên bản đồ>" style="padding: 1rem; border: 1px gainsboro solid" />
        <input type="text" class="clearable" id="txtRoute" placeholder="<Nhập điểm đến hoặc Click trên bản đồ>" style="padding: 1rem; border: 1px gainsboro solid" />
        <a id="btnRouView" href="#" class="cms-button cms-button-small">Tìm</a>
        <select style="padding: 1rem; border: 1px gainsboro solid; margin-bottom: 15px">
            <option value="1">Chỉ đi 1 tuyến</option>
            <option value="2">Hành trình tối đa 2 chuyến</option>
            <option value="3">Hành trình tối đa 3 tuyến</option>
        </select>
    </div>
    ...
    <div style="border: 1px gainsboro solid; padding: 0.2rem">
        ...
        <span">Bản quyền Trung tâm Quản lý Giao thông công cộng Thành phố Hồ Chí Minh <br />Phát triển bởi 
